@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center sm:justify-between justify-around">
        <div class="flex sm:justify-strat flex-1 sm:hidden justify-between">
